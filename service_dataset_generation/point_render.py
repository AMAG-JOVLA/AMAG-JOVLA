...
class BBox3D:
    ...
    def get_points(self):
        ...
        points = np.zeros((8, 3))
        points[0] = self.center - x_axis - y_axis - z_axis # 0
        points[1] = self.center + x_axis - y_axis - z_axis # 1
        points[2] = self.center - x_axis + y_axis - z_axis # 3
        points[3] = self.center - x_axis - y_axis + z_axis # 4
        points[4] = self.center + x_axis + y_axis + z_axis # 6
        points[5] = self.center - x_axis + y_axis + z_axis # 7
        points[6] = self.center + x_axis - y_axis + z_axis # 5
        points[7] = self.center + x_axis + y_axis - z_axis # 2
        return points
...
if __name__ == "__main__":
    ...
    argparser.add_argument("--output_dir", type=str, default='step1')
    ...
    argparser.add_argument("--export_ply", type=bool, default=True, help="Export ply")
